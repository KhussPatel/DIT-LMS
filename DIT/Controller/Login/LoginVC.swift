...
class LoginVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if !(UserDefaultsHelper.getAcceptPP() ?? false){
    ...
    @IBAction func btn_GUEST(_ sender: UIButton) {
        let loginVC = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "GHomeVC") as! GHomeVC
        self.navigationController?.pushViewController(loginVC, animated: true)
                ...
                do {
                    ...
                    if let stdData = studentData.result, stdData.count > 0{
                        ...
                        if let stdType = stdData[0].stdType, stdType == "g"{
                            ...
                            UserDefaultsHelper.setStudentFamilyName(stdData[0].familyName ?? "")
