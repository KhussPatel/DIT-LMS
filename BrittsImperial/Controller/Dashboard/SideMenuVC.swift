...
class SideMenuVC: UIViewController {
    ...
    var arrMenuImage = ["side-usericon","password","side-logout"]
    var arrMenu = ["Profile","Change Password","Logout"]
    //MARK: View Life Cycle
    override func viewDidLoad() {
        super.viewDidLoad()

        // Do any additional setup after loading the view.
        lblUserName.text = "\(UserDefaultsHelper.getStudentFName() ?? "") \(UserDefaultsHelper.getStudentFMName() ?? "")"
