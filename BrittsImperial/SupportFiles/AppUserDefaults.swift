...
class UserDefaultsHelper {
    ...
    private enum Keys {
        ...
        static let studentFname = "studentFname"
    ...
    static func setStudentFName(_ value: String) {
        UserDefaults.standard.set(value, forKey: Keys.studentFname)
    }
    static func getStudentFName() -> String? {
        return UserDefaults.standard.string(forKey: Keys.studentFname)
    }
